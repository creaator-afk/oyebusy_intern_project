...
const MixedContentLeftCard = ({href, image, title, date, content}) => (
    <div className="ultp-block-item ultp-block-media post-id-154">
        <div className="ultp-block-content-wrap">
            <div className="ultp-block-image ultp-block-image-none">
                <a
                    href={href}>
                    <img
                        srcSet={image}
            ...
            <div className="ultp-block-content">
                ...
                <div className="ultp-block-meta ultp-block-meta- ultp-block-meta-icon">
                ...
                <div className="ultp-block-excerpt"><p>{content}</p>
                </div>
            </div>
        </div>
    </div>
...
export default MixedContentLeftCard;